...
set ( LIBFTDI_FOUND 1 )
set ( LIBFTDI_USE_FILE     "/data/data/com.diamon.curso/files/usr/lib/cmake/libftdi1/UseLibFTDI1.cmake" )

set ( LIBFTDI_DEFINITIONS  "" )
set ( LIBFTDI_INCLUDE_DIR  "/data/data/com.diamon.curso/files/usr/include/libftdi1" )
set ( LIBFTDI_INCLUDE_DIRS "/data/data/com.diamon.curso/files/usr/include/libftdi1" )
set ( LIBFTDI_LIBRARY      "ftdi1" )
set ( LIBFTDI_LIBRARIES    "ftdi1;/data/data/com.termux/files/home/fake_root/data/data/com.diamon.curso/files/usr/lib/libusb-1.0.so" )
set ( LIBFTDI_STATIC_LIBRARY      "ftdi1.a" )
set ( LIBFTDI_STATIC_LIBRARIES    "ftdi1.a;/data/data/com.termux/files/home/fake_root/data/data/com.diamon.curso/files/usr/lib/libusb-1.0.so" )
set ( LIBFTDIPP_LIBRARY    "ftdipp1" )
set ( LIBFTDIPP_LIBRARIES  "ftdipp1;/data/data/com.termux/files/home/fake_root/data/data/com.diamon.curso/files/usr/lib/libusb-1.0.so" )
set ( LIBFTDI_LIBRARY_DIRS "/data/data/com.diamon.curso/files/usr/lib" )
set ( LIBFTDI_ROOT_DIR     "/data/data/com.diamon.curso/files/usr" )

set ( LIBFTDI_VERSION_STRING "1.6rc1" )
set ( LIBFTDI_VERSION_MAJOR  "1" )
set ( LIBFTDI_VERSION_MINOR  "6" )
set ( LIBFTDI_VERSION_PATCH  "" )

set ( LIBFTDI_PYTHON_MODULE_PATH "/data/data/com.diamon.curso/files/usr/lib/python3.14/site-packages" )
